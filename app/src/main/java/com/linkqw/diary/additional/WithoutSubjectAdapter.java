...
public class WithoutSubjectAdapter extends RecyclerView.Adapter<WithoutSubjectAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.totals_without_sub_row, parent, false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            totalCount = itemView.findViewById(R.id.totalCountWS);
            respectCount = itemView.findViewById(R.id.respectCountWS);
            disrespectCount = itemView.findViewById(R.id.disrespectCountWS);
            personUnit = itemView.findViewById(R.id.personUnitWS);
        }
    }
